...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 ...
 , (select count(*) from snowflake.information_schema.databases 
   where database_name in ('DB_SI_JP', 'SNOWFLAKE_INTELLIGENCE')) as actual
 , 2 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI02' as step
 , (select count(*) from DB_SI_JP.information_schema.stages) as actual
 , 6 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI03' as step
 , (select count(*) from DB_SI_JP.information_schema.tables where table_name in ('MARKETING_CAMPAIGN_METRICS', 'PRODUCTS', 'SALES','SOCIAL_MEDIA', 'SUPPORT_CASES')) as actual
 , 5 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI04' as step
 , (select count(*) from DB_SI_JP.information_schema.applicable_roles where role_name = 'SNOWFLAKE_INTELLIGENCE_ADMIN') as actual
 , 1 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI06' as step
 , (select count(distinct metadata$filename) from @DB_SI_JP.retail.semantic_models where metadata$filename = 'marketing_campaigns.yaml') as actual
 , 1 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI08' as step
 , (select count(*) from DB_SI_JP.information_schema.functions where function_name = 'ROUNDTOWHOLE') as actual
 , 1 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI09' as step
 , (select count(*) from DB_SI_JP.information_schema.functions where function_name = 'AVGPRICEPERUNITPRODUCTPERSALE') as actual
 , 1 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI10' as step
 , (select count(*) from DB_SI_JP.information_schema.views where table_name = 'AVG_PRICE_PER_UNIT_PRODUCT_PER_SALE') as actual
 , 1 as expected
...
select util_db.public.grader(step, (actual = expected), actual, expected, description) as graded_results from (SELECT
 'BWSI11' as step
 , (select count(*) from DB_SI_JP.information_schema.tables where table_name = 'PRODUCTS_WITH_AVG_PRICE') as actual
 , 1 as expected
